            ...
            "1" => loop {
                ...
                match selection.trim() {
                    ...
                    "p" if opponent_selection == "s" => {
                        println!(
                            "You selected paper and opponent selected scissors. Opponent wins!"
                        );
                        break;
                    }
                    ...
                    "s" if opponent_selection == "r" => {
                        println!(
                            "You selected scissors and opponent selected rock. Opponent wins!"
                        );
                        break;
                    }
                    ...
                    "s" if opponent_selection == "p" => println!(
                        "You selected scissors and opponent selected scissors. It's a draw!"
                    ),
                    _ => break,
                }
            },
